  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          <h1 className="text-[26px] font-bold text-[#0f172a] tracking-tight mb-1">Team</h1>
        ...
        {isAdmin && (
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-2.5 text-[13px] font-semibold text-white bg-[#0f172a] rounded-xl hover:bg-[#1e293b] transition-colors shadow-sm"
          >
              ...
              {inviteSent ? (
                ...
                <form onSubmit={handleInvite} className="flex gap-3">
                  <input
                    ...
                    required
                    className="flex-1 bg-[#f8fafc] border border-[#e2e8f0] rounded-xl px-4 py-2.5 text-[13px] text-[#0f172a] placeholder-[#94a3b8] outline-none focus:border-[#0ea5e9]/50 focus:bg-white transition-all"
                  />
                  <select
                    value={inviteRole}
                  ...
                  <button
                    type="submit"
                    disabled={inviting}
                    className="px-5 py-2.5 text-[13px] font-semibold text-white bg-[#0ea5e9] rounded-xl hover:bg-[#0284c7] transition-colors disabled:opacity-60 flex items-center gap-2"
                  >
      ...
      <div className="relative mb-5">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 text-[13px] bg-white border border-[#e2e8f0] rounded-xl text-[#0f172a] placeholder-[#94a3b8] outline-none focus:border-[#0ea5e9]/50 transition-all shadow-sm"
        />
      </div>
        ...
        {isLoading ? (
          ...
          filtered.map((member, i) => (
            <motion.div
              ...
              className="grid grid-cols-[2fr_2fr_1fr_100px_44px] px-5 py-4 border-b border-[#f8fafc] last:border-0 hover:bg-[#fafafa] transition-colors items-center group"
            >
              <div className="flex items-center gap-3">
                <div
              ...
              <div className="flex justify-center">
                {isAdmin && member.id !== user?.id && (
                  <button className="opacity-0 group-hover:opacity-100 w-7 h-7 flex items-center justify-center text-[#94a3b8] hover:text-[#64748b] hover:bg-[#f1f5f9] rounded-lg transition-all">
